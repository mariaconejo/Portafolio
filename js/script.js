const apiUrl = 'https://api.github.com/users/mariaconejo/repos?per_page=50';
...
let i=0
let images=["./img/dibujo.jpg", "./img/dibujo-2.png","./img/dibujo-3.jpg","./img/dibujo-4.png","./img/dibujo-5.png","./img/dibujo-6.jpg","./img/dibujo-7.jpg","./img/dibujo.jpg","./img/dibujo-8.jpg","./img/dibujo-9.png","./img/dibujo-10.jpg"];
